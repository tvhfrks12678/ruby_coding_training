...
describe 'demo' do
	...
	problems.push({input: [-1, 0, -3, 2, 3 ], answer: 1})
	problems.push({input: [-1, 0, 1, 2, 3, 5], answer: 4})
	problems.push({input: [1000000, -1000000], answer: 1})
	problems.push({input: [999999,1000000], answer: 1})
